...
@Component({
  selector: 'app-visor-estudiante',
  templateUrl: './visor-estudiante.component.html',
  styleUrls: ['./visor-estudiante.component.css']
})
export class VisorEstudianteComponent implements OnInit {
