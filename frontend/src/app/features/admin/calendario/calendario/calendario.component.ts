...
export class CalendarioComponent implements OnInit {
  ...
  private updateCurrentMonthAndYear() {
    ...
    this.currentMonthAndYear = `${monthName} de ${this.date.getFullYear()}`;
    this.año = monthName;
  }
  ...
  private addCalendarDay(year: number, month: number, day: number, isCurrentDay: boolean, isCurrentMonth: boolean) {
    ...
    this.calendarDays.push({
      day: isCurrentMonth ? day : null, currentDay: isCurrentDay,
      currentMonth: isCurrentMonth, events: this.getEventsForDate(date),
      date, isSunday, dayOfWeek: undefined
    });
  }
